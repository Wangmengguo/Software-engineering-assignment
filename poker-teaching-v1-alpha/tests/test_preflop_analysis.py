...
import pytest
from poker_core.analysis import classify_starting_hand, annotate_player_hand
...
@pytest.mark.parametrize("cards, expected_cat, why", [
...
# ---- 解析函数也踩一下，补掉顶部小函数的行 ----
@pytest.mark.parametrize("c, exp_rank, exp_suit", [
    ("As", "A", "s"),
    ("Td", "T", "d"),
    ("2h", "2", "h"),
])
